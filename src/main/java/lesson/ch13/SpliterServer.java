...
public class SpliterServer {
    ...
    public static void main(String[] args) {
        ...
        serverBootstrap.group(parent, children)
                ...
                .attr(AttributeKey.newInstance("serverName"), SpliterServer.class.getSimpleName())
                ...
                .childAttr(AttributeKey.newInstance("childServerName"), SpliterServer.class.getSimpleName() + "-child")
