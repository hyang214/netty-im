...
public class NoFrameServer {
    ...
    public static void main(String[] args) {
        ...
        serverBootstrap.group(parent, children)
                ...
                .attr(AttributeKey.newInstance("serverName"), NoFrameServer.class.getSimpleName())
                ...
                .childAttr(AttributeKey.newInstance("childServerName"), NoFrameServer.class.getSimpleName() + "-child")
