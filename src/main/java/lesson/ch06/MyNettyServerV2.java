...
public class MyNettyServerV2 {
    ...
    public static void main(String[] args) {
        ...
        serverBootstrap.group(parent, children)
                ...
                .attr(AttributeKey.newInstance("serverName"), MyNettyServerV2.class.getSimpleName())
                ...
                .childAttr(AttributeKey.newInstance("childServerName"), MyNettyServerV2.class.getSimpleName() + "-child")
