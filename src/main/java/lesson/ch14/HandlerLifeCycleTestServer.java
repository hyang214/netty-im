...
import lesson.ch13.frame.Spliter;
import lesson.ch14.test.LifeCyCleTestHandler;
 ...
 */
@Slf4j
public class HandlerLifeCycleTestServer {
    ...
    public static void main(String[] args) {
        ...
        serverBootstrap.group(parent, children)
                ...
                .attr(AttributeKey.newInstance("serverName"), HandlerLifeCycleTestServer.class.getSimpleName())
                ...
                .childAttr(AttributeKey.newInstance("childServerName"), HandlerLifeCycleTestServer.class.getSimpleName() + "-child")
